...
import { communities } from '@/public/data/index';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="relative mb-20 text-center">
                    ...
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        Members from <span className="text-[#4ade80]">Communities</span>
                    </motion.h2>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true }}
                    >
                        Join hands with members from other top tech communities to expand your network and skills
                    </motion.p>
                </div>
                ...
                >
                    {communities.map((community, index) => (
                        ...
                        >
                            ...
                            >
                                <p className="pixel-text text-white text-xs whitespace-nowrap">{community.name}</p>
                            </motion.div>
                        </motion.div>
                    ))}
                </motion.div>
                ...
                >
                    <motion.a
                        ...
                        whileTap={{ scale: 0.95 }}
                    >
                        <span className="relative z-10">Explore All Communities</span>
                        <motion.div
