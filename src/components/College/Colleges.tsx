...
const Colleges: React.FC = () => {
    ...
    // Generate stars and particles on client-side only
    useEffect(() => {
        // Generate stars
        const newStars: Star[] = [];
        for (let i = 0; i < 80; i++) {
    ...
    return (
        <div className="relative py-20 lg:py-32 bg-black overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                {/* Particles - now using pre-generated values */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="relative mb-20 text-center">
                    ...
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                    >
                        Members from <span className="text-[#4ade80]">Colleges</span>
                    </motion.h2>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true }}
                    >
                        Students from multiple institutions collaborating under one tech-driven platform
                    </motion.p>
                </div>
                        ...
                        >
                            <div className="aspect-[4/3] bg-[#080808] rounded-lg relative flex flex-col items-center justify-center p-6 border border-gray-800">
                                ...
                                <div className="absolute inset-0 rounded-lg overflow-hidden">
                                    <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[#4ade80] rounded-full opacity-5 blur-xl"></div>
                                    <div className="absolute -top-10 -right-10 w-40 h-40 bg-cyan-400 rounded-full opacity-5 blur-xl"></div>
                                </div>

                                <div className="relative z-10 w-full h-3/4 flex items-center justify-center">
                                    <Image
                                        src={`https://utfs.io/f/${partner.img}`}
                                        alt={partner.name}
                                ...
                                <p className="pixel-text text-[#4ade80] text-lg mt-2 text-center relative z-10">
                                    {partner.name}
                                </p>
                            </div>
                            ...
                            >
                                <p className="pixel-text text-white text-xs whitespace-nowrap">{partner.name}</p>
                            </motion.div>
                        </motion.div>
                    ))}
                </motion.div>
